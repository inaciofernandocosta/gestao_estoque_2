...
const ResponsiveLayout = ({ children }: ResponsiveLayoutProps) => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="w-full px-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              <span className="text-nexablue font-bold text-xl">Nexa</span>
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="p-2 rounded-lg hover:bg-gray-100">
              <HelpCircle size={20} className="text-nexablue" />
            </button>
          </div>
        </div>
      </header>
      ...
      <aside
        className={`fixed top-14 left-0 h-[calc(100vh-3.5rem)] bg-nexablue text-white border-r border-nexablue-dark transition-all duration-300 z-20
        ...
        <nav className="h-full py-4">
          <ul className="space-y-1">
            {menuItems.map((item, index) => (
              <li key={index}>
                <button
                  className={`w-full flex items-center gap-3 px-4 py-2 text-white hover:bg-nexablue-dark transition-colors
